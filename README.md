...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------- |
| Recaptured Raw Screen Image and Video Demoiréing via Channel and Spatial Modulations | [NeurIPS-2023](https://arxiv.org/pdf/2310.20332.pdf)         | [VD_raw](https://github.com/tju-chengyijia/VD_raw)           | [RawVDemoiré](https://github.com/tju-chengyijia/VD_raw)      |                             |
